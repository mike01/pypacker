...
class IEEE80211(pypacker.Packet):
	...
	def _unpack(self, buf):
		...
		try:
			...
			packet._set_bodyhandler( parser( buf[offset:] ) )

			# TODO: auto-parse QOS-Data as sub-type
	...
	def __unpack_ies(self, buf):
		...
		return pypacker.TriggerList(ies)
	...
	class Beacon(pypacker.Packet):
		...
		# TODO: properties for capability
		def _unpack(self, buf):
			ies = IEEE80211.unpack_ies(buf[12:])
			self._add_headerfield("ies", "", ies)
			pypacker.Packet._unpack(self, buf)
